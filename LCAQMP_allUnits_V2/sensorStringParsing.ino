/* Functions in this part are called to return parsed values used for printing to SD and serial.
 */


//SDS011
String getSDS011StringLastReading(){ // Gets SDS-data
...
String getGPSStringLastReading(){
  ...
  if(gpsLatestReadResult){
    ...
    return GPSStringLatestReading = GPSTimeString + "," + GPSPositionString;
  }
...
//NEXT SENSOR BELOW
String getAFEStringHeader(){
  return "SN1_WE_u, SN1_AE_u, SN2_WE_u, SN2_AE_u, NO2, O3, PT1000 temp";
}
